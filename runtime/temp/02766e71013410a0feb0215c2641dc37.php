<?php /*a:4:{s:73:"C:\phpStudy\PHPTutorial\WWW\ar\application\admin\view\projects\index.html";i:1538966109;s:65:"C:\phpStudy\PHPTutorial\WWW\ar\application\admin\view\layout.html";i:1538966109;s:72:"C:\phpStudy\PHPTutorial\WWW\ar\application\admin\view\public\header.html";i:1538966109;s:72:"C:\phpStudy\PHPTutorial\WWW\ar\application\admin\view\public\footer.html";i:1538966109;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>项目列表</h2>
                <a type="button" class="navbar-right panel_toolbox btn btn-primary" href="<?php echo url('admin/Projects/addPage'); ?>">添加项目</a>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td><?php echo htmlentities($vo['partnerName']); ?></td>
                        <td><?php echo htmlentities($vo['gameName']); ?></td>
                        <td><?php echo htmlentities($vo['waresName']); ?></td>
                        <td>
                            <?php if($vo['status'] == 1){ ?>
                        ...
                        <td>
                            <a href="<?php echo url('admin/Projects/editPage',array('project_id' => $vo['id'])); ?>">编辑</a>
                            <a href="<?php echo url('admin/Projects/delete',array('project_id' => $vo['id'])); ?>">删除</a>
                            <?php if($vo['status'] == 2){ ?>
                            <a href="<?php echo url('admin/Projects/updateStatus',array('project_id' => $vo['id'],'partner_id' => $vo['partner_id'])); ?>">设置启用</a>
                            <?php } ?>
                        </td>
                    </tr>
