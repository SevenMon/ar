...
<div class="container body">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br>
                <form id="form" data-parsley-validate="" data-parsley-required-message="不可为空！" class="form-horizontal form-label-left" novalidate="" action="<?php echo url('admin/Waress/edit',array('wares_id' => $waresData['id'])); ?>" method="post" class="dropzone" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="title" id="title" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo htmlentities($waresData['name']); ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="upload one" id="case" data-num="1" data-type="png,jpg" action="<?php echo url('api/Publicapi/waresImgUpload'); ?>" data-value="<?php echo htmlentities($waresData['pic']); ?>"></div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <textarea id="remark" required="required" class="form-control" name="message"><?php echo htmlentities($waresData['introduce']); ?></textarea>
                        </div>
                    </div>
