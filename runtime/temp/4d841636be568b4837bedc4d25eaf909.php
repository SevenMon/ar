<?php /*a:4:{s:71:"C:\phpStudy\PHPTutorial\WWW\ar\application\admin\view\waress\index.html";i:1538966109;s:65:"C:\phpStudy\PHPTutorial\WWW\ar\application\admin\view\layout.html";i:1538966109;s:72:"C:\phpStudy\PHPTutorial\WWW\ar\application\admin\view\public\header.html";i:1538966109;s:72:"C:\phpStudy\PHPTutorial\WWW\ar\application\admin\view\public\footer.html";i:1538966109;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>商品列表</h2>
                <a class="navbar-right panel_toolbox btn btn-danger" style="margin-left: 20px" type="button"  href="<?php echo url('admin/Brands/index',array('brand_id' => $brandId)); ?>">返回</a>
                <a type="button" class="navbar-right panel_toolbox btn btn-primary" href="<?php echo url('admin/Waress/addPage',array('brand_id' => $brandId)); ?>">添加商品</a>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td><img src="<?php echo htmlentities($vo['pic']); ?>" style="width: 80px;" /></td>
                        <td><?php echo htmlentities($vo['name']); ?></td>
                        <td style="max-width: 160px;word-wrap:break-word;"><?php echo htmlentities($vo['introduce']); ?></td>
                        <td>
                            <a href="<?php echo url('admin/Waress/editPage',array('wares_id' => $vo['id'],'brand_id' => $brandId)); ?>">编辑</a>
                            <a href="<?php echo url('admin/Waress/delete',array('wares_id' => $vo['id'],'brand_id' => $brandId)); ?>">删除</a>
                        </td>
                    </tr>
