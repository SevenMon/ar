<?php /*a:4:{s:70:"C:\phpStudy\PHPTutorial\WWW\ar\application\admin\view\users\index.html";i:1538966109;s:65:"C:\phpStudy\PHPTutorial\WWW\ar\application\admin\view\layout.html";i:1538966109;s:72:"C:\phpStudy\PHPTutorial\WWW\ar\application\admin\view\public\header.html";i:1538966109;s:72:"C:\phpStudy\PHPTutorial\WWW\ar\application\admin\view\public\footer.html";i:1538966109;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                <table class="table table-hover">
                    ...
                    <tr id="user_item_<?php echo htmlentities($vo['id']); ?>">
                        <th scope="row"><?php echo (($list->currentPage()-1)*$list->listRows() + $k) ?></th>
                        <td><img width="60px" src="<?php echo htmlentities($vo['avatar_url']); ?>" /></td>
                        <td><?php echo urlsafe_b64decode($vo['nickname']); ?></td>
                        <td><?php echo htmlentities($vo['gender']); ?></td>
                        <td><?php echo htmlentities($vo['openid']); ?></td>
                        <th><?php echo getPartnerInfo($vo['partner_id'],'name'); ?></th>
                        <td>
                            <a href="<?php echo url('admin/Users/detail',array('user_id' => $vo['id'])); ?>">详情</a> |
                            <a href="#" onclick="addblack(<?php echo htmlentities($vo['id']); ?>)">加入黑名单</a>
                        </td>
                    </tr>
...
<script>
    function addblack(user_id) {
        var url = "<?php echo url('admin/Users/ajaxAddBlackLIst'); ?>"+"?user_id="+user_id;
        $.ajax({
            type: 'GET',
            url: url,
            dataType: 'json',
