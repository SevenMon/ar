<?php /*a:4:{s:71:"C:\phpStudy\PHPTutorial\WWW\ar\application\admin\view\brands\index.html";i:1539051853;s:65:"C:\phpStudy\PHPTutorial\WWW\ar\application\admin\view\layout.html";i:1539051853;s:72:"C:\phpStudy\PHPTutorial\WWW\ar\application\admin\view\public\header.html";i:1539051853;s:72:"C:\phpStudy\PHPTutorial\WWW\ar\application\admin\view\public\footer.html";i:1539051853;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>品牌列表</h2>
                <a type="button" class="navbar-right panel_toolbox btn btn-primary" href="<?php echo url('admin/Brands/addPage'); ?>">添加品牌</a>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo url('admin/Waress/index',array('brand_id' => $vo['id'])); ?>">查看商品</a>|
                            <a href="<?php echo url('admin/Brands/editPage',array('id' => $vo['id'])); ?>">编辑</a>|
                            <a href="<?php echo url('admin/Brands/delete',array('id' => $vo['id'])); ?>">删除</a>
                        </td>
                    </tr>
