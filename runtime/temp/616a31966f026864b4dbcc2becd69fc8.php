<?php /*a:4:{s:74:"C:\phpStudy\PHPTutorial\WWW\ar\application\admin\view\users\blacklist.html";i:1538966109;s:65:"C:\phpStudy\PHPTutorial\WWW\ar\application\admin\view\layout.html";i:1538966109;s:72:"C:\phpStudy\PHPTutorial\WWW\ar\application\admin\view\public\header.html";i:1538966109;s:72:"C:\phpStudy\PHPTutorial\WWW\ar\application\admin\view\public\footer.html";i:1538966109;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
                ...
                <table class="table table-hover">
                    ...
                    <tr id="user_item_<?php echo htmlentities($vo['id']); ?>">
                        ...
                        <td>
                            ...
                            <a href="#" onclick="addwhite(<?php echo htmlentities($vo['id']); ?>)">移除黑名单</a>
                        </td>
                    </tr>
...
<script>
    function addwhite(user_id) {
        var url = "<?php echo url('admin/Users/ajaxAddWhiteLIst'); ?>"+"?user_id="+user_id;
        $.ajax({
            type: 'GET',
            url: url,
            dataType: 'json',
