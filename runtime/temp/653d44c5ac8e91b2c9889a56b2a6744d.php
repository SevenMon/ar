<?php /*a:4:{s:77:"C:\phpStudy\PHPTutorial\WWW\ar\application\admin\view\partners\edit_page.html";i:1538966109;s:65:"C:\phpStudy\PHPTutorial\WWW\ar\application\admin\view\layout.html";i:1538966109;s:72:"C:\phpStudy\PHPTutorial\WWW\ar\application\admin\view\public\header.html";i:1538966109;s:72:"C:\phpStudy\PHPTutorial\WWW\ar\application\admin\view\public\footer.html";i:1538966109;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="container body">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br>
                <form data-parsley-validate="" data-parsley-required-message="不可为空！" class="form-horizontal form-label-left" novalidate="" action="<?php echo url('admin/Partners/edit',array('partner_id' => $partnerData['id'])); ?>" method="post">
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="title">名称 <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="title" id="title" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo htmlentities($partnerData['name']); ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="number" name="phone" id="phone" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo htmlentities($partnerData['phone']); ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="appid" id="appid" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo htmlentities($partnerData['appid']); ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="appsecret" id="appsecret" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo htmlentities($partnerData['appsecret']); ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <textarea id="remark" required="required" class="form-control" name="remark"><?php echo htmlentities($partnerData['remark']); ?></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12" style="padding-top: 6px;">
                            <input type="checkbox" class="js-switch" <?php echo $partnerData['status'] == 1 ? 'checked' : ''; ?> name="status" />
                        </div>
                    </div>
