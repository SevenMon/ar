<?php /*a:4:{s:71:"C:\phpStudy\PHPTutorial\WWW\ar\application\admin\view\admins\index.html";i:1538966109;s:65:"C:\phpStudy\PHPTutorial\WWW\ar\application\admin\view\layout.html";i:1538966109;s:72:"C:\phpStudy\PHPTutorial\WWW\ar\application\admin\view\public\header.html";i:1538966109;s:72:"C:\phpStudy\PHPTutorial\WWW\ar\application\admin\view\public\footer.html";i:1538966109;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="container body">
    ...
    <div class="x_title">
        <h2>管理员列表</h2>
        <a type="button" class="navbar-right panel_toolbox btn btn-primary" href="<?php echo url('admin/admins/add'); ?>">添加管理员</a>
        <div class="clearfix"></div>
    </div>
    <div class="x_content">
                ...
                <tr>
                    ...
                    <td>
                        <div class="col-md-6 col-sm-6 col-xs-12" style="padding-top: 6px;">
                            <input onchange="updateStatus(<?php echo htmlentities($val['aid']); ?>)" type="checkbox" class="js-switch" <?php if($val['status'] == 1)echo'checked'; ?> name="status" />
                        </div>
                    </td>
                    <td>
                        <?php echo date('Y-m-d H-i-s',$val['register_time']); ?>
                    </td>
                    <td>
                        <a href="<?php echo url('admin/admins/updatePasswordPage',['aid' => $val['aid']]); ?>">修改密码</a> |
                        <a href="#" onclick="resetPassword(<?php echo htmlentities($val['aid']); ?>)">重置密码</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
...
<script>
    function resetPassword(aid){
        var url = "<?php echo url('admin/admins/resetPassword'); ?>";
        $.ajax({
            type: 'GET',
            url: "<?php echo url('admin/admins/resetPassword'); ?>",
            data: {
                aid: aid
            },
            dataType: 'json',
    ...
    function updateStatus(aid) {
        var url = "<?php echo url('admin/admins/updateStatus'); ?>";
        $.ajax({
            type: 'GET',
            url: "<?php echo url('admin/admins/updateStatus'); ?>",
            data: {
                aid: aid
            },
            dataType: 'json',
