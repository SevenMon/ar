<?php /*a:4:{s:59:"/www/wwwroot/ar/application/admin/view/materials/index.html";i:1538571806;s:50:"/www/wwwroot/ar/application/admin/view/layout.html";i:1538571800;s:57:"/www/wwwroot/ar/application/admin/view/public/header.html";i:1538571814;s:57:"/www/wwwroot/ar/application/admin/view/public/footer.html";i:1538571814;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="x_content">
                ...
                <div class="form-horizontal form-label-left" novalidate="">
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">部件图片<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <table class="table table-bordered">
                                ...
                                <tbody id="imgcontent">
                                    <?php for($i = 1;$i <= $materailData['material_num'];++$i){ ?>
                                    <tr>
                                        <td>部件<?php echo $i; ?></td>
                                        <td>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <img width="100px" src="<?php echo $materailData['uncomplete_pic']; ?>" />
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <img width="100px" src="<?php echo $materailData['complete_pic']; ?>" />
                        </div>
                    </div>
