...
<div class="container body">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br>
                <form id="form" data-parsley-validate="" data-parsley-required-message="不可为空！" class="form-horizontal form-label-left" novalidate="" action="<?php echo url('admin/Brands/edit',array('id' => $brandData['id'])); ?>" method="post" class="dropzone" >
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="title">名称 <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="title" id="title" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo htmlentities($brandData['name']); ?>">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="remark">领取方式 <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <textarea id="remark" required="required" class="form-control" name="message"><?php echo htmlentities($brandData['type']); ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12" style="padding-top: 6px;">
                            <input type="checkbox" class="js-switch" <?php if($brandData['status'] == 1)echo'checked'; ?> name="status" />
                        </div>
                    </div>
