<?php /*a:4:{s:70:"C:\phpStudy\PHPTutorial\WWW\ar\application\admin\view\games\index.html";i:1538966109;s:65:"C:\phpStudy\PHPTutorial\WWW\ar\application\admin\view\layout.html";i:1538966109;s:72:"C:\phpStudy\PHPTutorial\WWW\ar\application\admin\view\public\header.html";i:1538966109;s:72:"C:\phpStudy\PHPTutorial\WWW\ar\application\admin\view\public\footer.html";i:1538966109;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>游戏列表</h2>
                <a type="button" class="navbar-right panel_toolbox btn btn-primary" href="<?php echo url('admin/Games/addPage'); ?>">添加游戏</a>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo(\app\model\GameType::TYPE[$vo['type']]['name']);  ?>
                        </td>
                        <td>
                            <?php if($vo['status'] == 1){ ?>
                        ...
                        <td>
                            <?php if($vo['materialStatus'] == 1){ ?>
                            <span class="green">已编辑</span>
                            <?php }else{ ?>
                            <span class="red">未编辑</span>
                            <?php } ?>
                        </td>
                        <td>

                            <?php if($vo['materialStatus'] == 1): ?>
                            <a href="<?php echo url('admin/Materials/index',array('games_id' => $vo['id'])); ?>">查看游戏素材</a>
                            <?php else: ?>
                            <a href="<?php echo url('admin/Materials/editPage',array('games_id' => $vo['id'])); ?>">编辑游戏素材</a>
                            <?php endif; ?>

                            <a href="<?php echo url('admin/Games/editPage',array('games_id' => $vo['id'])); ?>">编辑</a>
                            <a href="<?php echo url('admin/Games/delete',array('games_id' => $vo['id'])); ?>">删除</a>
                        </td>
                    </tr>
