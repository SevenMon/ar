<?php /*a:4:{s:71:"C:\phpStudy\PHPTutorial\WWW\ar\application\admin\view\users\argame.html";i:1538984854;s:65:"C:\phpStudy\PHPTutorial\WWW\ar\application\admin\view\layout.html";i:1538966109;s:72:"C:\phpStudy\PHPTutorial\WWW\ar\application\admin\view\public\header.html";i:1538966109;s:72:"C:\phpStudy\PHPTutorial\WWW\ar\application\admin\view\public\footer.html";i:1538966109;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 searchwarpper">
                    ...
                    <div class="searchitem">
                        ...
                        <select class="form-control" id="game_type_id" name="game_type_id">
                            <?php if(is_array($gameList) || $gameList instanceof \think\Collection || $gameList instanceof \think\Paginator): $i = 0; $__LIST__ = $gameList;if( count($__LIST__)==0 ) : echo "这里没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            　　<option value="<?php echo htmlentities($vo['id']); ?>"><?php echo htmlentities($vo['name']); ?></option>
                            <?php endforeach; endif; else: echo "这里没有数据" ;endif; ?>
                        </select>
                    </div>
                    ...
                    <div class="searchitem">
                        ...
                        <select class="form-control" id="partner_id" name="partner_id">
                            ...
                            <?php if(is_array($partnerList) || $partnerList instanceof \think\Collection || $partnerList instanceof \think\Paginator): $i = 0; $__LIST__ = $partnerList;if( count($__LIST__)==0 ) : echo "这里没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            　　<option <?php echo $partner_id == $vo['id'] ? 'selected' : '' ?> value="<?php echo htmlentities($vo['id']); ?>"><?php echo htmlentities($vo['name']); ?></option>
                            <?php endforeach; endif; else: echo "这里没有数据" ;endif; ?>
                        </select>
                    </div>
                ...
                <table class="table table-hover">
                    ...
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>
                        <tr>
                            ...
                            <td><?php echo htmlentities($vo['partner_name']); ?></td>
                            <td><?php echo htmlentities($vo['project_name']); ?></td>
                            <td><?php echo urlsafe_b64decode($vo['nickname']); ?></td>
                            <td><img width="70px" src="<?php echo htmlentities($vo['avatar_url']); ?>"></td>
                            <td><?php echo $vo['partStr']; ?></td>
                            <td><?php echo htmlentities($vo['is_complete_str']); ?></td>
