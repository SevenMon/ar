 ...
 * @method void mimeType(mixed $type, string $val = null) static 设置资源类型
 ...
 * @method mixed param(string $name = null, mixed $default = null, mixed $filter = null) static 获取当前请求的参数
 * @method mixed route(string $name = null, mixed $default = null, mixed $filter = null) static 设置获取路由参数
 * @method mixed get(string $name = null, mixed $default = null, mixed $filter = null) static 设置获取GET参数
 * @method mixed post(string $name = null, mixed $default = null, mixed $filter = null) static 设置获取POST参数
 * @method mixed put(string $name = null, mixed $default = null, mixed $filter = null) static 设置获取PUT参数
 * @method mixed delete(string $name = null, mixed $default = null, mixed $filter = null) static 设置获取DELETE参数
 * @method mixed patch(string $name = null, mixed $default = null, mixed $filter = null) static 设置获取PATCH参数
 * @method mixed request(string $name = null, mixed $default = null, mixed $filter = null) static 获取request变量
 * @method mixed session(string $name = null, mixed $default = null, mixed $filter = null) static 获取session数据
 * @method mixed cookie(string $name = null, mixed $default = null, mixed $filter = null) static 获取cookie参数
 * @method mixed server(string $name = null, mixed $default = null, mixed $filter = null) static 获取server参数
 * @method mixed env(string $name = null, mixed $default = null, mixed $filter = null) static 获取环境变量
 * @method mixed file(string $name = null) static 获取上传的文件信息
 * @method mixed header(string $name = null, mixed $default = null) static 设置或者获取当前的Header
 * @method mixed input(array $data,mixed $name = null, mixed $default = null, mixed $filter = null) static 获取变量 支持过滤和默认值
